...
export class CustomizerService {
  ...
  getSidebarColors() {
    let sidebarColors = ['black', 'slate', 'white', 'grey', 'deep-purple', 'orange', 'blue-grey', 'dark-blue',];
  ...
  gettopbarColors() {
    let topbarColors = ['black', 'slate', 'white', 'light-purple', 'dark-gray', 'purple', 'dark-blue', 'indigo', 'pink', 'red', 'amber', 'green'];
    return this.colors.filter(color => {
