...
export interface ILayoutConf {
  ...
  matTheme?: string; // material theme. marco-blue, marco-navy, marco-dark, marco-dark-pink
  ...
  constructor(private themeService: ThemeService) {
    this.setAppLayout(
      //******** SET YOUR LAYOUT OPTIONS HERE *********
      {
        ...
        sidebarColor: "black", // http://demos.ui-lib.com/marco-doc/#marco-colors
        sidebarCompactToggle: false, // applied when "sidebarStyle" is "compact"
        dir: "ltr", // ltr, rtl
        useBreadcrumb: true,
        topbarFixed: false,
        footerFixed: true,
        topbarColor: "black", // http://demos.ui-lib.com/marco-doc/#marco-colors
        footerColor: "black", // http://demos.ui-lib.com/marco-doc/#marco-colors
        matTheme: "marco-red", // marco-blue, marco-navy, marco-light-purple, marco-dark, marco-dark-pink
